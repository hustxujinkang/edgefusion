...
def main():
    ...
    print("    # Linux: .venv/bin/python modbus_charger_simulator.py")
    print("    # Windows: .venv\\Scripts\\python.exe modbus_charger_simulator.py")
    print("    python modbus_charger_simulator.py")
    print("\n2️⃣  打开另一个新的终端窗口，运行主程序：")
    print("    # Linux: .venv/bin/python -m edgefusion.main")
    print("    # Windows: .venv\\Scripts\\python.exe -m edgefusion.main")
    print("    python -m edgefusion.main")
    ...
    print("\n" + "="*60)
    print("📖 详细说明请查看: README.md / USAGE.md / DEPLOYMENT.md")
    print("="*60 + "\n")
